...
Prompt Drop Casino is a play-for-fun browser slot game built with plain HTML, CSS, and JavaScript. It renders a 5x3 reel board, evaluates 10 fixed paylines, supports adjustable wager and auto-play controls, shows live session play time, awards a once-per-day login bonus, tracks consecutive daily play streaks, persists theme/consent/reward state in `localStorage`, and includes a separate paytable view.
...
3. Watch the `Session Time`, `Daily Streak`, and `Daily Bonus` HUD cards for the current session and reward status.
