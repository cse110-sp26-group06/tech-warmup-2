...
Prompt Drop Casino is a play-for-fun browser slot game built with plain HTML, CSS, and JavaScript. It renders a 5x3 reel board, evaluates 10 fixed paylines, supports adjustable wager and auto-play controls, persists theme and consent state in `localStorage`, and includes a separate paytable view.
