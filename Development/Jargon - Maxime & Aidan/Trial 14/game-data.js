  ...
  const symbols = [
    {
      ...
      flavor: "Top-value premium symbol with the highest fixed payout.",
    },
    {
      key: "diamond",
      name: "Diamond",
      ...
      flavor: "High-value symbol with strong paytable returns.",
    },
    {
      key: "gold",
      name: "Gold",
      ...
      flavor: "Mid-tier premium symbol with balanced payouts.",
    },
    {
      key: "silver",
      name: "Silver",
      ...
      weight: 4,
      payouts: { 3: 2, 4: 4, 5: 8 },
      flavor: "Standard symbol with moderate payout frequency.",
    },
    {
      key: "bronze",
      name: "Bronze",
      ...
      weight: 5,
      payouts: { 3: 1, 4: 2, 5: 4 },
      flavor: "Low-value symbol with the most frequent appearances.",
    },
  ];
