 ...
 *
 * @param {object} line - The payline definition.
 ...
 *
 * @param {object} line - The configured payline definition.
 * @param {object[][]} grid - The resolved symbol grid for the completed spin.
 * @returns {object | null} The selected near-miss descriptor for the payline, if any.
 */
 ...
 *
 * @param {object[][]} grid - The resolved symbol grid for the completed spin.
 * @returns {object[]} The ordered near-miss paylines to render.
 */
 ...
 *
 * @param {object[]} [nearMisses=state.nearMisses] - The near-miss descriptors to render.
 * @returns {void}
 */
